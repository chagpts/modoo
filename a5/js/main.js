...
runDemo?.addEventListener('click', () => {
  ...
  reportPreview.textContent = '입력 데이터 정규화, 통제 기준 매핑, 예외 항목 산출 절차를 수행하고 있습니다.';
  ...
  setTimeout(() => {
    ...
    reportPreview.innerHTML = '<b>검토 문서 초안</b><br>중복 지급 의심 거래 12건, 증빙 누락 18건, 접근권한 예외 5건, 접속 로그 이상 징후 9건이 식별되었습니다. 중요도, 발생 빈도, 통제 영향도를 기준으로 우선순위를 부여하고 후속 검토 절차를 수행할 수 있습니다.';
  }, 900);
});
